  ...
  <div class="userManage">
    ...
    <div class="div">
        ...
        <el-table :data="tableData3" style="width: 80%" max-height="250" class="eltable">
            <el-table-column fixed prop="id" label="编号" width="150"></el-table-column>
            <el-table-column prop="content" label="登录账户" width="200"></el-table-column>
            <el-table-column prop="money" label="扣除金额" width="120"></el-table-column>
            <el-table-column fixed="right" label="操作" width="250">
                <template slot-scope="scope">
                    <el-button-group>
...
export default {
  ...
  data() {
    return {
    //数据
    sizeForm: {money:'',money1:"",money2:"",money3:"",money4:"",},
    ...
    baoxiu1:[],
    tableData1: [{id: "",memorysize:"",money: "",}],

    baoxiu2:[],
    tableData2: [{id: "",memorysize:"",money: "",}],

    baoxiu3:[],
    tableData3: [{id: "",memorysize:"",money: "",}],

    baoxiu4:[],
    tableData4: [{id: "",memorysize:"",money: "",}],
  ...
  created(){
      ...
      .then((res) => {
        ...
        for(var i=0; i<ww3.length; i++){
          if(ww3[i].assessid == 40){    //屏幕显示渲染
              this.baoxiu.push(ww3[i])
              this.tableData = this.baoxiu
          } else if(ww3[i].assessid == 41){
              this.baoxiu1.push(ww3[i])   // 维修情况渲染
              this.tableData1 = this.baoxiu1
          }
        else if(ww3[i].assessid == 38){
              this.baoxiu2.push(ww3[i])  ///开机情况渲染
              this.tableData2 = this.baoxiu2
          }else if(ww3[i].assessid == 39){  
              this.baoxiu3.push(ww3[i])  //登录账户渲染
              this.tableData3 = this.baoxiu3
          }else if(ww3[i].assessid == 42){
              this.baoxiu4.push(ww3[i])  //功能情况渲染
